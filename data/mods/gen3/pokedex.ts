export const Pokedex: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	...
	aggron: {
		inherit: true,
		baseStats: { hp: 90, atk: 110, def: 180, spa: 60, spd: 60, spe: 30 },
	},
	...
	banette: {
		inherit: true,
		baseStats: { hp: 64, atk: 103, def: 65, spa: 115, spd: 63, spe: 75 },
	},
	...
	beautifly: {
		inherit: true,
		baseStats: { hp: 60, atk: 80, def: 50, spa: 100, spd: 50, spe: 75 },
	},
	...
	bellossom: {
		inherit: true,
		baseStats: { hp: 90, atk: 80, def: 95, spa: 90, spd: 110, spe: 50 },
	},
	...
	cacnea: {
		inherit: true,
		baseStats: { hp: 50, atk: 85, def: 50, spa: 85, spd: 40, spe: 25 },
	},

	cacturne: {
		inherit: true,
		baseStats: { hp: 100, atk: 90, def: 90, spa: 115, spd: 70, spe: 35 },
	},
	...
	castform: {
		inherit: true,
		baseStats: { hp: 75, atk: 70, def: 75, spa: 85, spd: 75, spe: 90 },
	},
	...
	crawdaunt: {
		inherit: true,
		baseStats: { hp: 63, atk: 120, def: 85, spa: 100, spd: 55, spe: 55 },
	},
	...
	delcatty: {
		inherit: true,
		baseStats: { hp: 75, atk: 70, def: 70, spa: 75, spd: 65, spe: 95 },
	},
	...
	dusclops: {
		inherit: true,
		baseStats: { hp: 65, atk: 60, def: 130, spa: 75, spd: 130, spe: 25 },
	},
	...
	dustox: {
		inherit: true,
		baseStats: { hp: 70, atk: 50, def: 80, spa: 50, spd: 100, spe: 65 },
	},
	...
	ekans: {
		inherit: true,
		baseStats: { hp: 40, atk: 65, def: 44, spa: 40, spd: 54, spe: 60 },
	},
	...
	exploud: {
		inherit: true,
		baseStats: { hp: 114, atk: 101, def: 73, spa: 91, spd: 73, spe: 68 },
	},
	...
	flygon: {
		inherit: true,
		baseStats: { hp: 80, atk: 100, def: 80, spa: 90, spd: 80, spe: 100 },
	},
	...
	gloom: {
		inherit: true,
		baseStats: { hp: 70, atk: 65, def: 70, spa: 85, spd: 75, spe: 40 },
	},
	...
	grimer: {
		inherit: true,
		baseStats: { hp: 80, atk: 80, def: 50, spa: 40, spd: 75, spe: 25 },
	},
	...
	grumpig: {
		inherit: true,
		baseStats: { hp: 90, atk: 35, def: 70, spa: 90, spd: 110, spe: 85 },
	},

	gulpin: {
		inherit: true,
		baseStats: { hp: 85, atk: 43, def: 53, spa: 43, spd: 53, spe: 40 },
	},
	...
	illumise: {
		inherit: true,
		baseStats: { hp: 80, atk: 73, def: 75, spa: 47, spd: 90, spe: 85 },
	},
	...
	kecleon: {
		inherit: true,
		baseStats: { hp: 75, atk: 90, def: 70, spa: 70, spd: 120, spe: 40 },
	},
	...
	kirlia: {
		inherit: true,
		baseStats: { hp: 38, atk: 35, def: 35, spa: 75, spd: 65, spe: 50 },
	},
	...
	lairon: {
		inherit: true,
		baseStats: { hp: 70, atk: 90, def: 140, spa: 50, spd: 50, spe: 30 },
	},
	...
	lickitung: {
		inherit: true,
		baseStats: { hp: 95, atk: 70, def: 85, spa: 75, spd: 85, spe: 30 },
	},
	...
	loudred: {
		inherit: true,
		baseStats: { hp: 84, atk: 76, def: 43, spa: 71, spd: 43, spe: 48 },
	},

	ludicolo: {
		inherit: true,
		baseStats: { hp: 90, atk: 70, def: 70, spa: 100, spd: 100, spe: 70 },
	},
	...
	lunatone: {
		inherit: true,
		baseStats: { hp: 90, atk: 65, def: 65, spa: 95, spd: 85, spe: 70 },
	},

	luvdisc: {
		inherit: true,
		baseStats: { hp: 58, atk: 30, def: 75, spa: 70, spd: 75, spe: 102 },
	},
	...
	magcargo: {
		inherit: true,
		baseStats: { hp: 60, atk: 80, def: 130, spa: 90, spd: 90, spe: 30 },
	},
	...
	magmar: {
		inherit: true,
		baseStats: { hp: 75, atk: 95, def: 57, spa: 100, spd: 85, spe: 93 },
	},
	...
	makuhita: {
		inherit: true,
		baseStats: { hp: 82, atk: 60, def: 40, spa: 20, spd: 40, spe: 25 },
	},
	...
	marill: {
		inherit: true,
		baseStats: { hp: 70, atk: 20, def: 50, spa: 40, spd: 50, spe: 40 },
	},

	marowak: {
		inherit: true,
		baseStats: { hp: 65, atk: 80, def: 110, spa: 50, spd: 80, spe: 45 },
	},
	...
	mawile: {
		inherit: true,
		baseStats: { hp: 70, atk: 105, def: 105, spa: 55, spd: 55, spe: 50 },
	},

	medicham: {
		inherit: true,
		baseStats: { hp: 60, atk: 60, def: 75, spa: 90, spd: 75, spe: 80 },
	},

	meditite: {
		inherit: true,
		baseStats: { hp: 30, atk: 40, def: 55, spa: 60, spd: 55, spe: 60 },
	},
	...
	mightyena: {
		inherit: true,
		baseStats: { hp: 75, atk: 95, def: 75, spa: 60, spd: 60, spe: 80 },
	},
	...
	minun: {
		inherit: true,
		baseStats: { hp: 70, atk: 40, def: 80, spa: 65, spd: 95, spe: 85 },
	},

	misdreavus: {
		inherit: true,
		baseStats: { hp: 60, atk: 60, def: 60, spa: 95, spd: 95, spe: 90 },
	},
	...
	nosepass: {
		inherit: true,
		baseStats: { hp: 45, atk: 45, def: 135, spa: 70, spd: 105, spe: 30 },
	},
	...
	oddish: {
		inherit: true,
		baseStats: { hp: 50, atk: 50, def: 55, spa: 75, spd: 65, spe: 30 },
	},
	...
	pelipper: {
		inherit: true,
		baseStats: { hp: 70, atk: 50, def: 100, spa: 95, spd: 70, spe: 65 },
	},
	...
	plusle: {
		inherit: true,
		baseStats: { hp: 60, atk: 70, def: 40, spa: 95, spd: 65, spe: 105 },
	},
	...
	ponyta: {
		inherit: true,
		baseStats: { hp: 50, atk: 85, def: 55, spa: 65, spd: 65, spe: 100 },
	},
	...
	porygon: {
		inherit: true,
		baseStats: { hp: 75, atk: 70, def: 70, spa: 85, spd: 75, spe: 40 },
	},
	...
	qwilfish: {
		inherit: true,
		baseStats: { hp: 75, atk: 95, def: 85, spa: 65, spd: 75, spe: 85 },
	},
	...
	roselia: {
		inherit: true,
		baseStats: { hp: 55, atk: 65, def: 50, spa: 115, spd: 95, spe: 75 },
	},

	sableye: {
		inherit: true,
		baseStats: { hp: 70, atk: 75, def: 95, spa: 65, spd: 95, spe: 40 },
	},
	...
	sceptile: {
		inherit: true,
		baseStats: { hp: 70, atk: 85, def: 65, spa: 110, spd: 85, spe: 120 },
	},
	...
	seaking: {
		inherit: true,
		baseStats: { hp: 80, atk: 100, def: 65, spa: 65, spd: 80, spe: 68 },
	},
	...
	sharpedo: {
		inherit: true,
		baseStats: { hp: 80, atk: 120, def: 40, spa: 95, spd: 40, spe: 105 },
	},

	shedinja: {
		inherit: true,
		baseStats: { hp: 1, atk: 90, def: 45, spa: 75, spd: 30, spe: 40 },
	},
	...
	shellder: {
		inherit: true,
		baseStats: { hp: 35, atk: 65, def: 100, spa: 45, spd: 25, spe: 40 },
	},

	shiftry: {
		inherit: true,
		baseStats: { hp: 90, atk: 110, def: 60, spa: 95, spd: 60, spe: 85 },
	},
	...
	solrock: {
		inherit: true,
		baseStats: { hp: 70, atk: 95, def: 85, spa: 65, spd: 65, spe: 90 },
	},
	...
	spoink: {
		inherit: true,
		baseStats: { hp: 60, atk: 25, def: 40, spa: 70, spd: 80, spe: 65 },
	},
	...
	swalot: {
		inherit: true,
		baseStats: { hp: 115, atk: 73, def: 83, spa: 73, spd: 83, spe: 55 },
	},
	...
	vileplume: {
		inherit: true,
		baseStats: { hp: 90, atk: 80, def: 95, spa: 100, spd: 90, spe: 50 },
	},

	volbeat: {
		inherit: true,
		baseStats: { hp: 70, atk: 88, def: 55, spa: 87, spd: 65, spe: 85 },
	},
	...
	vulpix: {
		inherit: true,
		baseStats: { hp: 45, atk: 41, def: 45, spa: 60, spd: 70, spe: 75 },
	},
